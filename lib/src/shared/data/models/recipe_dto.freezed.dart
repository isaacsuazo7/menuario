...
mixin _$RecipeDTO {
 ...
 String get name; List<BomLineDTO> get bomLines;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RecipeDTO&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.bomLines, bomLines));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,const DeepCollectionEquality().hash(bomLines));

@override
String toString() {
  return 'RecipeDTO(name: $name, bomLines: $bomLines)';
}
...
@useResult
$Res call({
 String name, List<BomLineDTO> bomLines
});
...
/// Create a copy of RecipeDTO
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? bomLines = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  List<BomLineDTO> bomLines)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RecipeDTO() when $default != null:
return $default(_that.name,_that.bomLines);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  List<BomLineDTO> bomLines)  $default,) {final _that = this;
switch (_that) {
case _RecipeDTO():
return $default(_that.name,_that.bomLines);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  List<BomLineDTO> bomLines)?  $default,) {final _that = this;
switch (_that) {
case _RecipeDTO() when $default != null:
return $default(_that.name,_that.bomLines);case _:
  return null;
...
class _RecipeDTO extends RecipeDTO {
  const _RecipeDTO({required this.name, required final  List<BomLineDTO> bomLines}): _bomLines = bomLines,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RecipeDTO&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other._bomLines, _bomLines));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,const DeepCollectionEquality().hash(_bomLines));
...
/// Create a copy of RecipeDTO
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? bomLines = null,}) {
