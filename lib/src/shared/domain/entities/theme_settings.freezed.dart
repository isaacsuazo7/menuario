...
mixin _$ThemeSettings {
 ...
 ThemeMode get mode; Color get seed;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ThemeSettings&&(identical(other.mode, mode) || other.mode == mode)&&(identical(other.seed, seed) || other.seed == seed));
}
...
@override
String toString() {
  return 'ThemeSettings(mode: $mode, seed: $seed)';
}
...
/// Create a copy of ThemeSettings
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? mode = null,Object? seed = null,}) {
  return _then(_self.copyWith(
mode: null == mode ? _self.mode : mode // ignore: cast_nullable_to_non_nullable
as ThemeMode,seed: null == seed ? _self.seed : seed // ignore: cast_nullable_to_non_nullable
as Color,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ThemeMode mode,  Color seed)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ThemeSettings() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ThemeMode mode,  Color seed)  $default,) {final _that = this;
switch (_that) {
case _ThemeSettings():
return $default(_that.mode,_that.seed);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ThemeMode mode,  Color seed)?  $default,) {final _that = this;
switch (_that) {
case _ThemeSettings() when $default != null:
return $default(_that.mode,_that.seed);case _:
  return null;
...
class _ThemeSettings extends ThemeSettings {
  const _ThemeSettings({required this.mode, required this.seed}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ThemeSettings&&(identical(other.mode, mode) || other.mode == mode)&&(identical(other.seed, seed) || other.seed == seed));
}
...
/// Create a copy of ThemeSettings
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? mode = null,Object? seed = null,}) {
